...
module.exports.run = async function({ api, event }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		...
		return api.sendMessage(`Đã kết nối với bot thành công ! Vui lòng sử dung lệnh -help  để biết toàn bộ lệnh có trên bot\Cảm ơn các bạn đã sử dụng bot của Trần Trọng Mạnh, chúc các bạn sử dụng bot vui vẻ`, threadID);
	}
	else {
		try {
